...
async function exportToZIP() {
    ...
    // PER IL FILE ZIP: Usiamo l'approccio con un unico index che include CSS e JS per rendere il pacchetto ZIP "portatile" e funzionante anche offline.
...
<div class="w-full max-w-5xl bg-white rounded-2xl shadow-2xl overflow-hidden flex flex-col min-h-[750px] relative border border-gray-200">
    ...
    <div id="nav-step" class="striped-footer flex justify-center gap-3 flex-wrap mt-auto"></div>
            ...
            playerHTML = playerHTML.replace(/\\/g, ""); // Pulisce eventuali escape nello script jsZip
            
            // Il file esportato userà un finto core.js "incluso" come stringa così lo zip è standalone
            const coreJsString = `
